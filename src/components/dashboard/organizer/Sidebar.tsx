...
const sidebars: SidebarItem[] = [
  { name: "OverView", path: "/my-dashboard/organizer/overview", icon: LucideChartSpline },
  {
    name: "My Raffles",
    path: "/my-dashboard/organizer/my-raffles",
    icon: GiMagnifyingGlass,
  },
  {
    name: "Draw Tool",
    path: "/my-dashboard/organizer/draw-tool",
    icon: FaUsers,
  },
  {
    name: "Notifications    ",
  ...
  { name: "My Profile", path: "/my-dashboard/organizer/my-profile", icon: Settings },
];
