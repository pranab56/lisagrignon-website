      ...
      <div className="container mx-auto max-w-7xl">
          ...
          {causes.map((cause) => (
            ...
            >
              <CardContent className="p-0 flex flex-col h-full">
                {/* Logo Section */}
                <div className="bg-white p-3 sm:p-4 md:p-5 lg:p-6 flex justify-center items-center border-b flex-shrink-0">
                  <LogoSVG />
                </div>

                {/* Cause Badge */}
                <div className="px-3 sm:px-4 md:px-5 lg:px-6 pt-3 sm:pt-4 flex-shrink-0">
                  <span className="inline-block bg-teal-50 text-teal-700 text-xs font-medium px-2 sm:px-3 py-1 rounded-full border border-teal-200">
                    Cause
                  </span>
                </div>
        ...
        <div className="text-center mb-4 sm:mb-5 md:mb-6">
          <p className="text-gray-700 text-xs sm:text-sm">
            You can select only one cause for your donation.
          </p>
          <p className="text-gray-700 text-xs sm:text-sm mt-1 sm:mt-2">
            {selectedCause !== null
              ? `Selected: ${causes.find(c => c.id === selectedCause)?.name}`
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
          ...
          <Button
            ...
            className="px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 bg-teal-600 hover:bg-teal-700 text-white rounded-md font-medium text-sm sm:text-base order-2 sm:order-1"
          >
            Continue
          ...
          <Button
            variant="outline"
            className="px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 text-teal-600 border-2 border-teal-600 hover:bg-teal-50 rounded-md font-medium text-sm sm:text-base order-1 sm:order-2"
          >
